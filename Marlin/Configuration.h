...
#define STRING_CONFIG_H_AUTHOR "(Ben, initial config)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,99}  // default steps per unit for Ultimaker
